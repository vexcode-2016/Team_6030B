...
$(document).ready(function() {
    ...
    */
    ...
    function getJSON(){
       //console.log.log("Asked to get JSON");
        ...
        $.post(
            ...
            function(data) {
                ...
                if(data[0].JINX.MID > timestamp) { //Assume strictly increasing data
                     ...
                     //console.log.log("Finished parsing JSON");
                      setTimeout(getJSON, 50);
                     //console.log.log("Set timeout to get more data");
                      //numDatareceived = numDatareceived + 1;
    ...
    function backupRequester() {
        if (!gotResponse) {
          getJSON();
         //console.log.log("Had to invoke server communications watchdog");
        } else {
          gotResponse = false;
        }
